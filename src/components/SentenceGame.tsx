        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {availableWords.map((word, index) => (
                  <WordCard
                    ...
                    className="word-hover cursor-pointer"
                  />
                ))}
              </div>
            </Card>
            ...
            <Card className={`p-6 bg-card/80 backdrop-blur-sm border-ocean-light/30 ${isShaking ? 'shake-animation' : ''} ${showSuccess ? 'animate-success-bounce' : ''}`}>
              ...
              <div className="min-h-[80px] flex flex-wrap gap-3 justify-center items-center p-4 bg-ocean-mid/30 rounded-lg border-2 border-dashed border-ocean-light/50">
                {userOrder.length === 0 ? (
